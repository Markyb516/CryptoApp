...
// MARK: - Testing Init
    init(){
        ...
        selectedDetailedCoin = DetailedCoinDataModel(
            id: "bitcoin",
            symbol: "btc",
            name: "bitcoin", blockTimeInMinutes: 20.00,
            hashingAlgorithm: "testing",
            previewListing: true,
            additionalNotices: ["sdsdsds"],
